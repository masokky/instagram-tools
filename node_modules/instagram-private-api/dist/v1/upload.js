...
class Upload extends resource_1.InstagramResource {
    ...
    static video(session, videoBufferOrPath, photoStreamOrPath, isSidecar, fields) {
        ...
        return helpers_1.Helpers.pathToBuffer(videoBufferOrPath).then((buffer) => {
            ...
            return request
                ...
                return Bluebird.mapSeries(chunks, (chunk, i) => _sendChunkedRequest(session, uploadData.params.uploadUrl, uploadData.params.uploadJob, sessionId, chunk.data, chunk.range, isSidecar))
                    .then(results => {
